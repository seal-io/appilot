...
from walrus.context import GLOBAL_CONTEXT
...
class ListServicesTool(BaseTool):
    ...
    def _run(self, query: str) -> str:
        project_id = GLOBAL_CONTEXT.project_id
        environment_id = GLOBAL_CONTEXT.environment_id
        try:
...
class ConstructServiceToCreateTool(BaseTool):
    ...
    def _run(self, text: str) -> str:
        ...
        prompt = PromptTemplate(
            ...
            partial_variables={
                "context": json.dumps(GLOBAL_CONTEXT.__dict__),
